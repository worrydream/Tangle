...
setupTypedArray("Uint32Array",  "WebGLUnsignedIntArray");  // bv 3-11-2011
...
function FFT(bufferSize, sampleRate) {
  ...
  for (i = 0; i < bufferSize; i++) {
    this.sinTable[i] = Math.sin(i ? (-Math.PI/i) : 0);   // bv 3-11-2011
    this.cosTable[i] = Math.cos(i ? (-Math.PI/i) : 0);
  }
}
